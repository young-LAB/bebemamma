...
<link href="./realsignup.css" rel="stylesheet" type="text/css">
...
<body onLoad="regFrm.id.focus()" class="goto-here">
	...
	<form id ="signupForm" name ="regFrm" action="signup_action.jsp" method="post">
    <fieldset>

      <h3 id="signup">회원가입</h3>
      <p>아이디 : <input class="tx" type="text" name="id" placeholder="아이디 입력" />&nbsp&nbsp&nbsp<input type="button" value="ID중복확인" onClick="idCheck(this.form.id.value)"></p>
      ...
      <p>현재 아이의 연령대는? <input class="tx" type="text" name="age" placeholder="나이 입력" />&nbsp(개월)
      </p>

      <p>현재 아이의 키, 몸무게를 입력해주세요. (카우프 지수 측정용)<br>
        <input class="tx"type="text" name="height" placeholder="키 입력" />&nbspcm
      <input class="tx" type="text" name="weight" placeholder="몸무게 입력" />&nbspkg</p>
