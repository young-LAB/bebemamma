...
(11, '사과감자죽', '베베쿡', '쌀가루,감자,사과', '.'),
(12, '양배추한우죽', '베베쿡', '쌀가루,양배추,한우', '.'),
(13, '고구마타락죽', '베베쿡', '쌀가루,고구마,분유', '.'),
(14, '한우근대죽', '베베쿡', '쌀가루,한우,근대', '.'),
(15, '사과타락죽', '베베쿡', '쌀가루,사과,분유', '.'),
(16, '한우감자죽', '베베쿡', '쌀가루,한우,감자', '.'),
(17, '수수고구마죽', '베베쿡', '쌀가루,고구마,차수수가루', '.'),
(18, '한우김가루죽', '베베쿡', '쌀가루,한우,김가루', '.'),
(19, '양송이배추죽', '베베쿡', '쌀가루,배추,양송이버섯', '.'),
(20, '애호박한우죽', '베베쿡', '쌀가루,애호박,한우', 'bebe_hanwoo_errgaree_lettuce_soup.JPG'),
(21, '사과적양배추죽', '베베쿡', '쌀가루,사과,붉은양배추', '.'),
(22, '배한우죽', '베베쿡', '쌀가루,한우,배', '.'),
(23, '찹쌀비타민죽', '베베쿡', '쌀가루,감자,비타민채,찹쌀가루', '.'),
(24, '브로콜리닭살죽', '베베쿡', '쌀가루,닭가슴살,브로콜리,분유', '.'),
(25, '찹쌀시금치죽', '베베쿡', '쌀가루,찹쌀가루,시금치', '.'),
(26, '시금치닭살죽', '베베쿡', '쌀가루,닭가슴살,시금치,분유', '.'),
(27, '감자배추죽', '베베쿡', '쌀가루,감자,배추', '.'),
(28, '한우무죽', '베베쿡', '쌀가루,무,한우', '.'),
(29, '고구마당근죽', '베베쿡', '쌀가루,고구마,당근', '.'),
(30, '한우로메인죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,로메인,쥬키니,양파', 'bebe_hanwoo_puretofu_soup.JPG'),
(31, '순두부새송이죽', '베베쿡', '쌀,야채육수,순두부,새송이버섯,비타민채', '.'),
(32, '한우버섯죽', '베베쿡', '쌀,쇠고기육수,야채육수,애호박,한우,감자,새송이버섯,팽이버섯,양파,뽕잎분말', '.'),
(33, '닭살애호박죽', '베베쿡', '쌀,야채육수,닭가슴살,쥬키니,애호박,분유', '.'),
