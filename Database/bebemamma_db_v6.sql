...
(36, '한우아욱죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,쌀,아욱,뽕잎분말', 'empty'),
...
(40, '한우브로콜리죽', '베베쿡', '쌀,야채육수,쇠고기육수,한우,컬리플라워,브로콜리,양파,뽕잎분말', 'empty'),
(41, '순두부대추죽', '베베쿡', '쌀,순두부,건대추,뽕잎분말', 'bebe_puretofu_jujube_soup.JPG'),
(42, '한우배추죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,얼갈이배추,배추,양파,뽕잎분말', 'empty'),
(43, '한우야채죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,애호박,양배추,당근,양파,뽕잎분말', 'bebe_hanwoo_vegetable_soup.JPG'),
(44, '잔멸치무죽', '베베쿡', '쌀,야채육수,무,시금치,잔멸치', 'bebe_littleanchovy_raddish_soup.JPG'),
(45, '한우양배추죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,양배추,양파,뽕잎분말', 'bebe_hanwoo_lettuce_soup.JPG'),
(46, '브로콜리단호박죽', '베베쿡', '쌀,단호박,고구마,브로콜리', 'bebe_brocoli_sweet_pumpkin_soup.JPG'),
(47, '한우와야채영양죽', '베베쿡', '쌀,한우,쥬키니,당근,브로콜리,양파,뽕잎분말', 'bebe_hanwoo_vegetable_nutrition_soup.JPG'),
(48, '애호박다시마죽', '베베쿡', '쌀,애호박,건다시마,뽕잎분말', 'bebe_young_pumpkin_dacima_soup.JPG'),
(49, '두부청경채죽', '베베쿡', '쌀,두부,야채육수,쇠고기육수,청경채,얼갈이배추,양파', 'bebe_tofu_cheonggyeongchae_soup.JPG'),
(50, '단호박어린잎채소죽', '베베쿡', '쌀,쇠고기육수,쌀,단호박,비타민채,당근,청경채,로메인,뽕잎분말', 'empty'),
(51, '배즙한우죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,배,청경채,양배추,뽕잎분말', 'bebe_pearl_juice_hanwoo_soup.JPG'),
(52, '한우대추찹쌀죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,늙은호박,찹쌀,건대추', 'empty'),
(53, '두부야채죽', '베베쿡', '쌀,순두부,얼갈이배추,애호박,볶음콩가루,뽕잎분말', 'bebe_tofu_vegetable_soup.JPG'),
(54, '한우청경채죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,청경채,얼갈이배추,양파', 'bebe_hanwoo_cheonggyeongchae_soup.JPG'),
(55, '닭살배추진밥', '베베쿡', '쌀,닭가슴살,야채육수,배추,무,찹쌀,양파,분유,다시마가루,양파가루', 'empty'),
(56, '시금치치즈섞음밥', '베베쿡', '쌀,애호박,시금치,찹쌀,당근,양파,치즈,양파가루', 'empty'),
(57, '한우대추찹쌀죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,늙은호박,찹쌀,건대추', 'empty'),
(58, '삼색야채무른밥', '베베쿡', '쌀,야채육수,단호박,당근,감자,찹쌀,비타민채,양파,참기름 ,뽕잎분말', 'empty'),
(59, '한우아스파라거스진밥', '베베쿡', '쌀,야채육수,한우,새송이버섯,찹쌀,당근,양파,아스파라거스,다진마늘,생강즙', 'empty'),
(60, '닭살들깨가루진밥', '베베쿡', '쌀,야채육수,닭가슴살,애호박,새송이버섯,찹쌀,청경채,양파,다진마늘,생강즙', 'empty'),
(61, '시금치치즈섞음밥', '베베쿡', '쌀,애호박,시금치,찹쌀,당근,양파,치즈,양파가루', 'empty'),
(62, '한우영양솥밥', '베베쿡', '쌀,한우,야채육수,찹쌀,양송이버섯,밤,다진마늘,생강즙,참기름', '.'),
(63, '연어야채볶음밥', '베베쿡', '쌀,감자,연어,쥬키니,당근,찹쌀,파슬리분말,다진마늘,생강즙,양파', '.'),
(64, '감자배추죽', '베베쿡', '쌀가루,감자,배추', 'bebe_potato_cabbage_soup.JPG'),
(65, '한우무죽', '베베쿡', '쌀가루,무,한우', 'bebe_hanwoo_raddish_soup.JPG'),
...
(72, '고구마오트밀죽', '베베쿡', '쌀,고구마,당근,오트밀가루', 'bebe_sweetpotato_oatmeal_soup.JPG'),
(73, '한우아욱죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,쌀,아욱,뽕잎분말', '.'),
(74, '닭살단호박죽', '베베쿡', '쌀,야채육수,단호박,닭가슴살,분유,뽕잎분말', '.'),
(75, '한우청경채죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,청경채,양파,뽕잎분말', 'bebe_hanwoo_cheonggyeongchae_soup.JPG'),
(76, '고구마단호박죽', '베베쿡', '쌀,야채육수,고구마,단호박,당근', 'bebe_sweetpotato_sweet_pumpkin_soup.JPG'),
(77, '한우브로콜리죽', '베베쿡', '쌀,야채육수,쇠고기육수,한우,컬리플라워,브로콜리,양파,뽕잎분말', 'empty'),
(78, '순두부대추죽', '베베쿡', '쌀,순두부,건대추,뽕잎분말', '.'),
(79, '한우배추죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,얼갈이배추,배추,양파,뽕잎분말', 'empty'),
(80, '한우야채죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,애호박,양배추,당근,양파,뽕잎분말', 'bebe_hanwoo_vegetable_soup.JPG'),
(81, '잔멸치무죽', '베베쿡', '쌀,야채육수,무,시금치,잔멸치', 'bebe_littleanchovy_raddish_soup.JPG'),
(82, '한우양배추죽', '베베쿡', '쌀,쇠고기육수,야채육수,한우,양배추,양파,뽕잎분말', 'bebe_hanwoo_lettuce_soup.JPG'),
(83, '브로콜리단호박죽', '베베쿡', '쌀,단호박,고구마,브로콜리', 'bebe_brocoli_sweet_pumpkin_soup.JPG'),
(84, '한우와야채영양죽', '베베쿡', '쌀,한우,쥬키니,당근,브로콜리,양파,뽕잎분말', 'bebe_hanwoo_vegetable_nutrition_soup.JPG'),
(85, '애호박다시마죽', '베베쿡', '쌀,애호박,건다시마,뽕잎분말', 'bebe_young_pumpkin_dacima_soup.JPG'),
(86, '한우청경채죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,청경채,얼갈이배추,양파', 'bebe_hanwoo_cheonggyeongchae_soup.JPG'),
(87, '단호박어린잎채소죽', '베베쿡', '쌀,쇠고기육수,쌀,단호박,비타민채,당근,청경채,로메인,뽕잎분말', '.'),
(88, '배즙한우죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,배,청경채,양배추,뽕잎분말', 'bebe_pearl_juice_hanwoo_soup.JPG'),
(89, '한우대추찹쌀죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,늙은호박,찹쌀,건대추', '.'),
(90, '두부야채죽', '베베쿡', '쌀,순두부,얼갈이배추,애호박,볶음콩가루,뽕잎분말', 'bebe_tofu_vegetable_soup.JPG'),
(91, '한우청경채죽', '베베쿡', '쌀,한우,야채육수,쇠고기육수,청경채,얼갈이배추,양파', 'bebe_hanwoo_cheonggyeongchae_soup.JPG'),
...
(98, '시금치치즈섞음밥', '베베쿡', '쌀,애호박,시금치,찹쌀,당근,양파,치즈,양파가루', 'bebe_spinach_cheese_rice.JPG'),
(99, '한우영양솥밥', '베베쿡', '쌀,한우,야채육수,찹쌀,양송이버섯,밤,다진마늘,생강즙,참기름', '.'),
(100, '연어야채볶음밥', '베베쿡', '쌀,감자,연어,쥬키니,당근,찹쌀,파슬리분말,다진마늘,생강즙,양파', '.'),
(101, '쌀미음', '풀무원', '쌀가루,찹쌀가루', 'pul_rice_rice-water.JPG'),
(102, '사과미음', '풀무원', '쌀가루,찹쌀가루,사과퓨레', 'pul_apple_rice-water.JPG'),
(103, '청경채미음', '풀무원', '쌀가루,찹쌀가루,청경채', 'pul_cheonggyeongchae_rice-water.JPG'),
(104, '애호박미음', '풀무원', '쌀가루,찹쌀가루,애호박', 'pul_pumkin_rice-water.JPG'),
(105, '한우사과미음', '풀무원', '쌀가루,사과퓨레,쇠고기', 'pul_hanwoo_apple_rice-water.JPG'),
(106, '애호박감자미음', '풀무원', '쌀가루,증숙감자,애호박', 'pul_young_pumpkin_potato_rice-water.JPG'),
(107, '청경재고구마미음', '풀무원', '쌀가루,증숙고구마,청경채', 'pul_cheonggyeongchae_sweetpotato_rice-water.JPG'),
(108, '한우배미음', '풀무원', '쌀가루,배퓨레,쇠고기', 'pul_hanwoo_pearl_rice-water.JPG'),
(109, '단호박콜리플라워미음', '풀무원', '쌀가루,단호박퓨레,콜리플라워', 'pul_sweet_pumpkin_coliflower_rice-water.JPG'),
...
(113, '찹쌀달걀바나나죽', '풀무원', '쌀가루,찹쌀가루,채소상탕,유정란,단호박,증숙고구마,바바나퓨레,클로렐라원말', 'pul_chapsal_egg_banana_soup.JPG'),
(114, '한우두부퓨레', '풀무원', '찹쌀가루,두부,콜리플라워,쇠고기,증숙고구마,양파퓨레', 'pul_bean_carrot_tofu_soup.JPG'),
(115, '닭가슴살애호박당근죽', '풀무원', '쌀가루,닭가슴살,채소상탕,당근,애호박,양파퓨레,단호박퓨레,클로렐라원말', 'pul_chickenbreast_young_pumkin_carrot_soup.JPG'),
...
(123, '한우브로콜리감자죽', '풀무원', '쌀가루,쇠고기,채소상탕,브로콜리,무,당근,클로렐라원말', 'pul_hanwoo_brocolli_potato_soup.JPG'),
(124, '시금치멸치닭죽', '풀무원', '쌀가루,닭가슴살,채소상탕,증숙고구마,시금치퓨레,멸치분말', 'pul_spinach_anchovy_chicken_soup.JPG'),
(125, '완두콩당근두부죽', '풀무원', '쌀가루,두부,채소상탕,완두콩퓨레,당근,증숙고구마,클로렐라원말', 'pul_wandobean_carror_tofu_soup.JPG'),
...
(128, '쌀죽', '푸드케어', '쌀가루', '.');
(129, '고구마죽', '푸드케어', '쌀가루,고구마', '.');
(130, '양배추죽', '푸드케어', '쌀가루,양배추', '.');
(131, '브로컬리죽', '풀무원', '쌀가루,당근,쌈배추,사과퓨레,양파퓨레,사과,채소상탕', '.');
(132, '현미죽', '풀무원', '쌀가루,당근,쌈배추,사과퓨레,양파퓨레,사과,채소상탕', '.');
(133, '청경채죽', '풀무원', '쌀가루,당근,쌈배추,사과퓨레,양파퓨레,사과,채소상탕', '.');
(134, '배죽', '풀무원', '쌀가루,당근,쌈배추,사과퓨레,양파퓨레,사과,채소상탕', '.');
(135, '돼지호박죽', '풀무원', '쌀가루,당근,쌈배추,사과퓨레,양파퓨레,사과,채소상탕', '.');
(136, '쇠고기감자죽', '풀무원', '쌀가루,당근,쌈배추,사과퓨레,양파퓨레,사과,채소상탕', '.');
